...
//----------------------------------------------------
//Interupt from TIM3, handle 7-seg LED
//----------------------------------------------------
void handler_led() {
    ...
    switch (My7segBUFF[digit_current_pos]) {
        ...
        case 'm': case 'M': A_1; B_0; C_1; D_0; E_1; F_0; G_0; break;
    ...
    switch (digit_current_pos) {
        case 0: if (digit_current_dp == 1) {DP_1} dig1_on; break;
        case 1: if (digit_current_dp == 2) {DP_1} dig2_on; break;
        case 2: if (digit_current_dp == 3) {DP_1} dig3_on; break;
        case 3: if (digit_current_dp == 4) {DP_1} dig4_on; break;
        case 4: if (digit_current_dp == 5) {DP_1} dig5_on; break;
    }

    //hak da pratimo stanje input-a kao prva decimalna tacka :)
